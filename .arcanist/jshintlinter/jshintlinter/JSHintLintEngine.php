 ...
 *
 * https://github.com/facebook/arcanist/blob/7870e7f2e46d220ef39dfdf1cc3f4322a92e5198/src/lint/linter/ArcanistJSHintLinter.php
 * This is a copy of SingeLintEngine with a bug fix to only
 * lint .js paths. Fuck arcanist
 *
 * @group linter
 */
final class JSHintLintEngine extends ArcanistLintEngine {
  ...
  public function buildLinters() {
    ...
    $linter->setPaths(preg_grep('/\.js$/', $paths));
